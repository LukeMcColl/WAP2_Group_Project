...
class user(models.Model):
    ...
    username = models.CharField("Account name", max_length=20, default="", unique=True)
    password = models.CharField("Password", max_length=20, default="")
    name = models.CharField("Name", max_length=20, default="")
    img = models.ImageField("Avatar", upload_to="img", default="img/images.png")
    email = models.EmailField("Email", max_length=20, default="")
    bio = models.CharField("Biography", max_length=200, default="")
    favourite_shows = models.CharField("Favourite shows", max_length=200, default="")
